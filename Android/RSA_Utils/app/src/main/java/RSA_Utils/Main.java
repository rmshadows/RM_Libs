...
//        savePKCS8_RSA_as_PKCS1();
    ...
    public static void RSA_Utils_Test() throws UnsupportedEncodingException { // 自我测试
        // RSA_Utils总测试
        // 先生成密钥分别保存
    ...
    public static void PKCS1_Test() throws UnsupportedEncodingException {
    ...
    public static void loadPKCS1_key() {
        PrivateKey prk = RSA_PKCS1_Utils.loadPKCS1_PRK(new File("test.pem"));
        System.out.println(RSA_Tools.bytes2base64(prk.getEncoded()));
        PublicKey puk = RSA_PKCS1_Utils.loadPKCS1_PUK(new File("test.pub"));
        System.out.println(RSA_Tools.bytes2base64(puk.getEncoded()));
    }

    public static void savePKCS1_RSA(){
    ...
    public static void PKCS8_Test() throws UnsupportedEncodingException {
        PrivateKey r = RSA_PKCS8_Utils.loadPKCS8_PRK(new File("test.pem"));
        PublicKey u = RSA_PKCS8_Utils.loadPKCS8_PUK(new File("test.pub"));
        byte[] todo = "待加密".getBytes(RSA_Tools.CHARSET);
        String e;
    ...
    public static void savePKCS8_RSA_as_PKCS1(){
