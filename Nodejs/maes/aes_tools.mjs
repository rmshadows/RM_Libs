 ...
 * @returns 
 */
export const stringToBytes1 = (str) => {
    let bytes = new Array();
    let len, c;
    len = str.length;
    for (let i = 0; i < len; i++) {
 ...
 * @returns 
 */
export const bytesToString1 = (arr) => {
 ...
 * @returns 
 */
export const stringToBytes = (str, isGetBytes = true) => {
    let back = [];
    let byteSize = 0;
 ...
 * @returns 
 */
export const keyPadding = (stringKey, length) => {
    let result = [];
    if (stringKey != null) {
...
//  * @returns 
//  */
// export const arrayBufferToArray = (arrayBuffer) => {
//     let array = new Float32Array(arrayBuffer); // 转换成Float32Array
//     // console.log(array); // Float32Array [0, 0]
//     let arr = Array.from(array); // 转换成Array
//     // console.log(arr); // [0, 0]
//     return arr;
// }

// /**
//  * array => ArrayBuffer 128
//  * https://www.5axxw.com/questions/simple/9eeshx
//  * @param {*} arr 
//  * @returns 
//  */
// export const arrayToArrayBuffer1 = (arr) => {
//     let arrayBuffer = new ArrayBuffer(arr.length * 4); // 数组元素的字节长度为4
//     let array = new Int32Array(arrayBuffer); // 转换成Int32Array
 ...
 * @returns 
 */
export const arrayBufferToArray1 = (arrayBuffer) => {
 ...
 * @returns 
 */
export const arrayToArrayBuffer = (arr) => {
