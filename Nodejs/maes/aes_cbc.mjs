 ...
 * @returns 
 */
export const cbcCipher = (SecuritykeyStr, initVectorStr, pwdLength = 16) => {
    try {
        // 转字符串为byte[] padding
 ...
 * @returns 
 */
export const cbcDecipher = (SecuritykeyStr, initVectorStr, pwdLength = 16) => {
    try {
        // 转字符串为byte[] padding
        let bSecuritykeyStr = tools.keyPadding(SecuritykeyStr, pwdLength);
        let binitVectorStr = tools.keyPadding(initVectorStr, 16);
 ...
 * @returns 
 */
export const tEncrypt = (message, key, iv, length = 16) => {
    try {
 ...
 * @returns 
 */
export const tDecrypt = (hexmessage, key, iv, length = 16) => {
    try {
        // the decipher function
